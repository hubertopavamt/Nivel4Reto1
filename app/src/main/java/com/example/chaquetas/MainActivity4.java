...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawable1 = res1.getDrawable(R.drawable.pl1, getTheme());
        ...
        drawable2 = res2.getDrawable(R.drawable.pl2, getTheme());
        ...
        drawable3 = res3.getDrawable(R.drawable.pl3, getTheme());
